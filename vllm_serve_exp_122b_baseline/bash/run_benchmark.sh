...
PROMPT_FILE="${PROMPT_FILE:-vllm_serve_exp_122b_baseline/data/mixed_prompts_30s70l.jsonl}"
...
# 服务端参数例如 MAX_NUM_SEQS / MAX_NUM_BATCHED_TOKENS 请改 start_server.sh
# ===== End User Config =====
set -euo pipefail
...
python -m vllm_serve_exp_122b_baseline.client_benchmark \
  --base_url "$BASE_URL" \

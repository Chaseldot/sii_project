#!/usr/bin/env bash
# ===== User Config =====
RUN_TAG="${RUN_TAG:-14b_length_aware_v2}"
HOST="${HOST:-127.0.0.1}"
PORT="${PORT:-8040}"
...
RESULT_NAMESPACE="${RESULT_NAMESPACE:-vllm_serve_14b_length_aware_v2}"
...
python -m vllm_serve_exp_14b_length_aware_v2.client_benchmark \
  --base_url "$BASE_URL" \

...
def parse_args():
    ...
    parser.add_argument("--policy", type=str, default="length_aware_v2", choices=["fifo", "length_aware_v2"])
    ...
    parser.add_argument("--long_aging_wait_ms", type=float, default=30000.0)
...
def main():
    ...
    scheduler = LengthAwareScheduler(
        SchedulerConfig(
            ...
            long_aging_wait_ms=args.long_aging_wait_ms,
    ...
    print(f"[INFO] long_aging_wait_ms={args.long_aging_wait_ms}")

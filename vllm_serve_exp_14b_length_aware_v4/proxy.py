...
def parse_args():
    ...
    parser.add_argument("--policy", type=str, default="length_aware_v4", choices=["fifo", "length_aware_v4"])
    parser.add_argument("--short_threshold_chars", type=int, default=256)
    parser.add_argument("--short_weight", type=int, default=2)
    ...
    parser.add_argument("--adapt_window_size", type=int, default=128)
    parser.add_argument("--adapt_update_interval", type=int, default=64)
    parser.add_argument("--min_short_weight", type=int, default=1)
    parser.add_argument("--max_short_weight", type=int, default=3)
    parser.add_argument("--min_max_consecutive_short", type=int, default=2)
    parser.add_argument("--max_max_consecutive_short", type=int, default=6)
    parser.add_argument("--objective_short_p95_ttft_ms", type=float, default=45000.0)
    parser.add_argument("--constraint_max_long_p95_latency_ms", type=float, default=110000.0)
    parser.add_argument("--constraint_max_overall_p95_latency_ms", type=float, default=110000.0)
...
def main():
    ...
    scheduler = LengthAwareScheduler(
        SchedulerConfig(
            ...
            adapt_update_interval=args.adapt_update_interval,
            min_short_weight=args.min_short_weight,
            max_short_weight=args.max_short_weight,
            min_max_consecutive_short=args.min_max_consecutive_short,
            max_max_consecutive_short=args.max_max_consecutive_short,
            objective_short_p95_ttft_ms=args.objective_short_p95_ttft_ms,
            constraint_max_long_p95_latency_ms=args.constraint_max_long_p95_latency_ms,
            constraint_max_overall_p95_latency_ms=args.constraint_max_overall_p95_latency_ms,
        )
    )
    ...
    print(f"[INFO] adapt_window_size={args.adapt_window_size}")
    print(f"[INFO] adapt_update_interval={args.adapt_update_interval}")
    print(f"[INFO] objective_short_p95_ttft_ms={args.objective_short_p95_ttft_ms}")
    print(f"[INFO] constraint_max_long_p95_latency_ms={args.constraint_max_long_p95_latency_ms}")
    print(f"[INFO] constraint_max_overall_p95_latency_ms={args.constraint_max_overall_p95_latency_ms}")

# vLLM Serve 14B Length-Aware V6

`vllm_serve_exp_14b_length_aware_v6` 是独立的 14B 在线调度实验目录。
...
- `bash vllm_serve_exp_14b_length_aware_v6/bash/start_server.sh`
- `bash vllm_serve_exp_14b_length_aware_v6/bash/start_proxy.sh`
- `bash vllm_serve_exp_14b_length_aware_v6/bash/run_benchmark.sh`
- `bash vllm_serve_exp_14b_length_aware_v6/bash/run_all.sh`

当前实验进展和结果沉淀见：

- `vllm_serve_exp_14b_length_aware_v6/docs/INDEX.md`
